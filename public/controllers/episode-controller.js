...
define(
	 ...
	 */
	(Episode, ApplicationController, TouchEventProxy, SpinningWheel, $) => {
		"use strict";
		...
		class EpisodeController {
			...
			setup() {
				...
				$("#watched").on("click", () => this.setStatus("Watched"));
				$("#recorded").on("click", () => this.setStatus("Recorded"));
				$("#expected").on("click", () => this.setStatus("Expected"));
				$("#missed").on("click", () => this.setStatus("Missed"));
			...
			getStatusDate() {
				...
				const months = {0: "Jan", 1: "Feb", 2: "Mar", 3: "Apr", 4: "May", 5: "Jun", 6: "Jul", 7: "Aug", 8: "Sep", 9: "Oct", 10: "Nov", 11: "Dec"},
							parts = this.listItem.episode.statusDate.split("-"),
							MIN_PARTS = 2;
