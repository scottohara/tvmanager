	...
	describe("create", (): void => {
		...
		beforeEach(async (): Promise<string[]> => {
			...
			return Promise.all([
				...
				db.put("episodes", { id: "2", name: "Episode 2", seriesId: "1", status: "Recorded", statusDate: "", unverified: 0, unscheduled: 0, sequence: 1 }),
				db.put("episodes", { id: "1", name: "Episode 1", seriesId: "1", status: "Watched", statusDate: "", unverified: 0, unscheduled: 0, sequence: 1 }),
				db.put("episodes", { id: "3", name: "Episode 3", seriesId: "1", status: "Expected", statusDate: "2000-04-04", unverified: 1, unscheduled: 1, sequence: 2 }),
				...
				db.put("episodes", { id: "5", name: "Episode 5", seriesId: "2", status: "Recorded", statusDate: "2001-01-05", unverified: 0, unscheduled: 1, sequence: 2 }),
				...
				db.put("episodes", { id: "7", name: "Episode 7", seriesId: "3", status: "Watched", statusDate: "", unverified: 0, unscheduled: 1, sequence: 1 }),
				db.put("episodes", { id: "8", name: "Episode 8", seriesId: "3", status: "Recorded", statusDate: "", unverified: 0, unscheduled: 0, sequence: 2 }),
				db.put("episodes", { id: "9", name: "Episode 9", seriesId: "3", status: "Expected", statusDate: "2000-06-03", unverified: 0, unscheduled: 1, sequence: 3 })
			]);
		});
		...
		describe("listByUnscheduled", (): void => {
			it("should return a list of all unscheduled episodes", async (): Promise<Chai.Assertion> => (await episodesStore.listByUnscheduled()).should.deep.equal([
				...
				{ EpisodeID: "5", Name: "Episode 5", Status: "Recorded", StatusDate: "2001-01-05", Unverified: "false", Unscheduled: "true", Sequence: 2, SeriesID: "2", SeriesName: "Series 2", ProgramID: "2", ProgramName: "Program 2" }
			]));
		});
