...
export default class SeriesListController extends ViewController {
	...
	viewItem(itemIndex) {
		...
		this.appController.pushView("episodes", {listIndex: itemIndex, series: this.seriesList.items[itemIndex]});
	}
	...
	editItem(itemIndex) {
		...
		this.appController.pushView("series", {listIndex: itemIndex, series: this.seriesList.items[itemIndex]});
	}
