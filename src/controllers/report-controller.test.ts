...
describe("ReportController", (): void => {
	...
	describe("object constructor", (): void => {
		it("should return a ReportController instance", (): Chai.Assertion =>
			expect(reportController).to.be.an.instanceOf(ReportController));
		it("should set the report", (): Chai.Assertion =>
			expect(reportController["report"]).to.deep.equal(report));
	});

	describe("view", (): void => {
		it("should return the report view", (): Chai.Assertion =>
			expect(reportController.view).to.equal(ReportView));
	});
	...
	describe("setup", (): void => {
		...
		it("should set the header label", (): Chai.Assertion =>
			expect(String(reportController.header.label)).to.equal(
				report.reportName,
			));
		...
		it("should activate the controller", (): Chai.Assertion =>
			expect(reportController["activate"]).to.have.been.called);
	});
	...
	describe("viewItems", (): void => {
		...
		it("should set the list to view mode", (): Chai.Assertion =>
			expect((reportController["reportList"] as ListMock).action).to.equal(
				"view",
			));
